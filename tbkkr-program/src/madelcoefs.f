       ...
       SUBROUTINE MADELCOEFS(LPOT,A,SMAT,CLEB,ICLEB,IEND)
       implicit none
       include 'inc.fi'
...
c
     ...
     &                  smat(LM3D),dfac(0:lpotd,0:lpotd)
...
c---  > calculate b(lm1)
c     
c     do 160 lm1 = 1,lmpot
c     l1 = loflm(lm1)
c     b(lm1) = b(lm1) -
c     +                           2.0d0*fpi/real(2*l1+1)*smat(i1,i2,lm1)
c     160          continue
c     
