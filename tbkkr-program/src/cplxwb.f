      SUBROUTINE CPLXWB(PZ,FZ,QZ,SZ,TMAT,ALPHA,E,EK,KSRA,IPAN,IRCUT,
     +                  IRWS,VM2Z,DRDI,R,Z,LMAX,C,DROR,RS,S)
      implicit none
C ************************************************************************
...
C     .. Scalar Arguments ..
      ...
      INTEGER IPAN,IRWS,KSRA,KVSRA,LMAX
C     ..
C     .. Array Arguments ..
...
C     .. Local Scalars ..
     ...
     +               TLSQEZ,VALUE,W,X,Y
      DOUBLE PRECISION R1,RIRC,RSIRC,S1
