...
c
     ...
     +     52.916684096D0/
      DATA CPVBH,CFVBH,RPVBH,RFVBH/0.0504D0,0.0254D0,30.D0,
     +     75.D0/
...
c
      DO 10 IJ = 1,IJEND
        ...
        FPIRHO(IJ,1) = MAX(1.D-14,FPIRHO(IJ,1))
        SMAG = DSIGN(1.0D0,FPIRHO(IJ,2))
        FPIRHO(IJ,2) = SMAG*MIN(FPIRHO(IJ,1)-1.D-14,ABS(FPIRHO(IJ,2)))
