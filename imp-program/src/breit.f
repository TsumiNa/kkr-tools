...
c in reativistic case and the difference of fermi-contact-terms in non-
c reativistic case
...
C     ..
C     .. Scalar Arguments ..
      REAL*8 BREITI,FOURPI,GAUSS,R2RHO1,R2RHO2,RSQ
      INTEGER IR,IS,L,NONSRA,NRE
C     ..
C     .. Array Arguments ..
      REAL*8 DRDI(*),F(IRMD,*),G(IRMD,*),R(*),WGT(*)
C     ..
C     .. Local Scalars ..
      REAL*8 AL,C,RL,RR,SUM1,SUM2,ZERO
