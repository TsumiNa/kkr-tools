...
C     .. Array Arguments ..
     ...
     +                 WORK(IRMD,LMPOTD),WTYR(IJD,*),YR(IJD,*)
...
c
        ST1= DCLOCK()
C
C       write(6,*) ' before gradrl'
c       write(6,9111) iatyp,(ircut(ir,iatyp),ir=0,4)
c9111   format(1x,' iatyp ircut',10i5)
