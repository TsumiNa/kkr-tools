     ...
     +     SZ,NSRA,PZLM,QZLM,PZEKDR,QZEKDR,EK,LOFLM,irmd,irmind)
      Implicit None
c-----------------------------------------------------------------------
c                 R. Zeller      Oct. 1993
c-----------------------------------------------------------------------
...
C     .. Scalar Arguments ..
      COMPLEX*16 EK
      INTEGER IPAN,IRMIN,IRWS,LMAX,NSRA,irmd,irmind
C     ..
C     .. Array Arguments ..
      COMPLEX*16 EFAC(LMMAXD),FZ(IRMD,0:LMAXD),PZ(IRMD,0:LMAXD),
