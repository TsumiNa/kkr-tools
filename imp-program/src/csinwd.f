      SUBROUTINE CSINWD(F,FINT,IRMIN,IPAN,IRCUT)
      IMPLICIT NONE
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
C     .. Parameters ..
      INTEGER IRMD,IRNSD,LMAXD
      PARAMETER (irmd=1484,irnsd=508,lmaxd=4)
      INTEGER IPAND
      PARAMETER (IPAND=80)
      INTEGER IRMIND
      PARAMETER (IRMIND=IRMD-IRNSD)
      INTEGER LMMSQD
      PARAMETER (LMMSQD= (LMAXD+1)**4)
      REAL*8 A1,A2
...
C     ..
C     .. Array Arguments ..
      COMPLEX*16 F(LMMSQD,IRMIND:IRMD),FINT(LMMSQD,IRMIND:IRMD)
