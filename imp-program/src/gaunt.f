...
c
c     modified gaunt coefficients are also calculated defined by
c     the integral of y(l1,m1)*y(l2,m2)*y(l3,m3)*i**(l1-l2-l3)
c                               R. Zeller Sep. 1994
c-----------------------------------------------------------------------
C     .. Parameters ..
c
...
c
C     .. Array Arguments ..
      REAL*8 CLEB(NCLEB,2),W(*),YR(N,0:LASSLD,0:LASSLD)
